...
use super::handler::{interrupt_error, interrupt_stack};
use super::idt::IDT;
...
pub fn register_exceptions() {
    ...
    // Safety: All of these are valid handler functions generated by the interrupt_stack and
    // interrupt_error macros.
    unsafe {
